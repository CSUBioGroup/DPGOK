...
if __name__=='__main__':
    uniprot_sport_file1=sys.argv[2]
    uniprot_sport_file2=sys.argv[4]
    uniprot_sport_file3=sys.argv[6]
    ...
    go_file=sys.argv[10]
    bp_freq=int(sys.argv[12])
    cc_freq=int(sys.argv[14])
    mf_freq=int(sys.argv[16])
